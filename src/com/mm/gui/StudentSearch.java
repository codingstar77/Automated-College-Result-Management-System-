...
public class StudentSearch extends JFrame {
	...
	private static StudentSearch frame;
	...
	public StudentSearch() {
		...
		JLabel lblPrnNo = new JLabel("PRN No");
		...
		JLabel lblUniRollNo = new JLabel("Uni. Roll No");
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Student obj=new Student(textField.getText(),Integer.parseInt(textField_1.getText()),textField_2.getText(),
						textField_3.getText(),textField_4.getText(),textField_5.getText(),textField_6.getText(),
						textField_7.getText(),textField_8.getText());
				try {
					StudentDAO.addOneStudent(ConnectionDAO.getCon(), obj,2);
		...
		btnSearch.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					Student obj=StudentDAO.getOneStudent(ConnectionDAO.getStmt(), textField.getText());
					textField_1.setText(String.valueOf(obj.getRoll_no()));
					textField_2.setText(obj.getUni_roll());
					textField_3.setText(obj.getStud_name());
					textField_4.setText(obj.getDivision());
					textField_5.setText(obj.getYear());
					textField_6.setText(obj.getBranch());
					...
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(contentPane,"No Such Student Exists..");
					//e1.printStackTrace();
				}
			}
