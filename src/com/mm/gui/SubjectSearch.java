...
public class SubjectSearch extends JFrame{
	...
	private static SubjectSearch frame;
		...
		*/
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					SubjectDAO.addOneSubject(ConnectionDAO.getCon(), obj,2);
		...
		btnSearch.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					Subject obj=SubjectDAO.getOneSubjectByCode(ConnectionDAO.getStmt(),Integer.parseInt( textField.getText()));
					textField_1.setText(obj.getSub_name());
					textField_2.setText(obj.getYear());
					textField_3.setText(obj.getBranch());
					textField_4.setText(obj.getBatch());
					...
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(contentPane,"No Such Subject Exists..");
					//e1.printStackTrace();
				}
			}
