...
public class TeacherGUI extends JFrame {
	...
	private static TeacherGUI frame;
	...
	public TeacherGUI() {
		...
		JLabel lblPrnNo = new JLabel("Name");
		...
		JLabel lblRollNo = new JLabel("Subject Id");
		...
		JLabel lblDivision = new JLabel("Sem");
		...
		JLabel lblYear = new JLabel("Division");
	...
	/*	textField_6 = new JTextField();
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Teacher obj=new Teacher(textField.getText(),Integer.parseInt(textField_1.getText()),textField_2.getText(),
						textField_3.getText(),Integer.parseInt(textField_4.getText()),textField_5.getText());
				try {
		...
		btnSave.setBounds(332, 413, 89, 30);
		...
		btnCancel.setBounds(78, 413, 89, 30);
