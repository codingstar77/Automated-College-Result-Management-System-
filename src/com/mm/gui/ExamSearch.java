...
public class ExamSearch extends JFrame{
	...
	private static ExamSearch frame;
	/**
	...
	public ExamSearch() {
		...
		JLabel lblBranch = new JLabel("Name");
		...
		JLabel lblMaxMarks = new JLabel("Batch");
		...
		textField_b.setFont(new Font("Tahoma", Font.PLAIN, 17));
		textField_b.setColumns(10);
		textField_b.setBorder(new MatteBorder(0, 0, 2, 0, (Color) new Color(0, 0, 0)));
		textField_b.setBounds(152, 284, 334, 27);
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Exam obj=new Exam(Integer.parseInt(textField.getText()),textField_1.getText(),textField_2.getText(),
						textField_3.getText(),Integer.parseInt(textField_4.getText()),textField_b.getText(),
						Integer.parseInt(textField_5.getText()),Integer.parseInt(textField_6.getText()),Integer.parseInt(textField_7.getText()),
						Integer.parseInt(textField_8.getText()),Integer.parseInt(textField_9.getText()));
				try {
					ExamDAO.addOneExam(ConnectionDAO.getCon(), obj,2);
		...
		search.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					ConnectionDAO.EstablishConnection();
					Exam obj=ExamDAO.getOneExam(ConnectionDAO.getStmt(),Integer.parseInt(textField.getText()));
					textField_1.setText(obj.getExam_name());
					textField_2.setText(obj.getBranch());
					textField_3.setText(obj.getYear());
					textField_4.setText(String.valueOf(obj.getSem()));
					textField_b.setText(obj.getBatch());
					textField_5.setText(String.valueOf(obj.getInsem_max()));
					textField_6.setText(String.valueOf(obj.getEndsem_max()));
					textField_7.setText(String.valueOf(obj.getPrac_max()));
					textField_8.setText(String.valueOf(obj.getTw_max()));
					textField_9.setText(String.valueOf(obj.getOral_max()));
					textField.disable();
					btnSave.enable();
					
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(contentPane,"No Such Exam Exists..");
					e1.printStackTrace();
				} 
			}
