...
public class TeacherSearch extends JFrame{
	...
	private static TeacherSearch frame;
	...
	public TeacherSearch() {
		...
		JLabel lblPrnNo = new JLabel("Teacher Id");
		...
		JLabel lblUniRollNo = new JLabel("Subject Id");
		...
		JLabel lblDivision = new JLabel("Branch");
		...
		JLabel lblBranch = new JLabel("Division");
		...
		btnSearch.setBounds(525,25, 90, 30);
		...
		btnSave.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Teacher obj=new Teacher(textField_1.getText(),Integer.parseInt(textField_2.getText()),textField_3.getText(),
						textField_4.getText(),Integer.parseInt(textField_5.getText()),textField_6.getText());
				try {
					TeacherDAO.addOneTeacher(ConnectionDAO.getCon(), obj,1);
		...
		btnSearch.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					Teacher obj=TeacherDAO.getOneTeacher(ConnectionDAO.getStmt(), Integer.parseInt(textField.getText()));
					textField_1.setText(obj.getT_name());
					textField_2.setText(String.valueOf(obj.getSub_id()));
					textField_3.setText(obj.getYear());
					textField_4.setText(obj.getBranch());
					textField_5.setText(String.valueOf(obj.getSem()));
					textField_6.setText(obj.getDivision());
					/*textField_7.setText(obj.getBatch());
					textField_8.setText(obj.getEmail());*/
					textField.disable();
					btnSave.enable();
					
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(contentPane,"No Such Teacher Exists..");
					//e1.printStackTrace();
				}
			}
